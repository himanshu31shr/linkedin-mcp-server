...
import {
  CreateTextPostInputSchema,
  CreateLinkPostInputSchema,
 ...
 */
export function registerPostTools(server: McpServer, client: LinkedInClient): void {
  server.registerTool(
    'create_text_post',
    {
    ...
    async (input) => {
      return createTextPost(client, input as CreateTextPostInput);
    },
  );
  ...
  server.registerTool(
    ...
    async (input) => {
      return createLinkPost(client, input as CreateLinkPostInput);
    },
  );
  ...
  server.registerTool(
    ...
    async (input) => {
      return deletePost(client, input as DeletePostInput);
    },
  );
