...
import {
  GetOrgPageStatisticsSchema,
  GetOrgFollowerStatisticsSchema,
  GetOrgShareStatisticsSchema,
 ...
 */
export function registerOrgAnalyticsTools(server: McpServer, client: LinkedInClient): void {
